...
private:
  ...
  Vector<Result> m_result;  // -- NOTE: CANNOT initialize member variables directly using Parenthesis-style initialization. 
                            //          Whoever made the Lab05Lab Document, thank you for wasting my fucking time.
};
