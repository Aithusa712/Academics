...
#include "course.h" //#include your own files first
...
// improve the run-time execution speed. It needs to be moved to the 
// implementation file .cpp without this evidence.
