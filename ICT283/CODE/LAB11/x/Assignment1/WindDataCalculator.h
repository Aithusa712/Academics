...
public:
    ...
    * @return WindlogType
    */
    WindlogType GetMonthlyData(const WindlogBST& wind_data, const string& year, const string& month);
    /**
    ...
    * @return void
    */
    void calculateAvgSpeed(const WindlogBST& wind_data);
    /**
    ...
    * @return void
    */
    void calculateAvgTemp(const WindlogBST& wind_data);
    /**
    ...
    * @return void
    */
    void calculateAll(const WindlogBST& wind_data);
    /**
    ...
    */
    ...
    void calculateSPCCForMonth(const WindlogBST& wind_data);
