...
In the video, the tree algorithm is modified to cater for a new requirement. This approach is not acceptable – see Open Closed Principle. Think of a better solution. Other than that, the video explains the BST and its use very **well**.
...
Be mindful of the advice given in the lab document. It is preparation for the project/assignment 2. It is important to work in stages and improve iteratively.
