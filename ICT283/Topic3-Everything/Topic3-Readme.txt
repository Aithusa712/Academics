...
Systems unit and the Foundations of Programming unit.
...
Step 1: 
Complete topics 1 and 2 if not already completed. The revision exercise has to be completed and submitted.
...
Step 3:
Go through the 3 PowerPoint files in Content. One of it is it is in the homework folder. Relate the contents of PowerPoint file in the homework folder what textbook readings from step 1 above.
...
When working on the registration code, use a debugger and single-step through the code to see how the calls are made. Activate the call stack and watch windows of the debugger.
