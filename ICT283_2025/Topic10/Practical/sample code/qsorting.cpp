...
// **lambda functions must not be used in labs and assignment 2**
// Use function pointers as above in assignment 2 and labs
...
int main()
{
    ...
    constexpr std::size_t size = sizeof a / sizeof *a; // can be computed at compile time
