...
You need to demonstrate both lab 5 and lab 6 in class to get feedback if you are on the right track for the assignment.

Progress on Assignments must be demonstrated in person for the assignment mark to be used to calculate the final total mark for the unit. Note that there are two assignments. We are currently in the assignment 1 preparation phase.
...
The read routine from Lab 6 has to be used otherwise the assignment will be considered as not working.
