...
You need to complete assignment 1.

Demonstrate assignment to your tutor. Assignment 1 may not be completed, so demonstrate your progress. 
...
o   Chapters on Standard Template Library, sections on Associative containers relating to set and multiset, container Adapters. We need the STL map data structure as well, but it doesn't have decent coverage in the textbook. The lecture notes and reference is sufficient for map.

o   Chapter on Stacks and Queues, entire section on Stacks

o   Chapter 1 "The Object Oriented Paradigm" of the ebook "Design Patterns Explained" by Shalloway 
	and Trott (in our library).
...
You will note that you are being asked to complete assignment 1 ASAP. Demonstrate assignment 1 to your tutor.
